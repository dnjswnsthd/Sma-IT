...
# 이미지 로드
imgElon = face_recognition.load_image_file('ImageBasic/mask3.jpg')
imgElon = cv2.cvtColor(imgElon, cv2.COLOR_BGR2RGB)

imgElon_test = face_recognition.load_image_file('ImageBasic/jun.jpg')
imgElon_test = cv2.cvtColor(imgElon_test, cv2.COLOR_BGR2RGB)

imgIU = face_recognition.load_image_file('ImageBasic/jun2.jpg')
