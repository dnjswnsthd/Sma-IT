  ...
  <v-container>
    ...
    <v-row>
      <div class="col-3 totalBox">
        ...
        <v-img @mouseover="domouseover_won" @click="checkTotal" v-if="!won_c" :src="require('../assets/images/won(w).png')" class="totalBtn"></v-img>
        <v-img @click="checkTotal" @mouseout="domouseout_won" class="totalBtn" v-else :src="require('../assets/images/won.png')"></v-img>
      ...
      <div class="col-6 cambox">
        <div class="camInBox">
          <div class="camTopBox">
            ...
            <video ref="video" id="video" playsinline muted autoplay class="videoBox"></video>
          </div>
      ...
      <div class="col-3 payBox">
        ...
        <v-img v-if="!pay_c" class="payBtn" @mouseover="domouseover_pay" @click="checkPayment" :src="require('../assets/images/click(w).png')"></v-img>
        <v-img v-else class="payBtn" @mouseout="domouseout_pay" @click="checkPayment" :src="require('../assets/images/click.png')"></v-img>
        ...
        <v-dialog v-model="payDialog" persistent max-width="500">
          <v-card>
            ...
            <v-card-text>
              <v-img :src="require('../assets/images/card.png')" style="margin-bottom:20px;"></v-img>
              <p style="color:#000; font-size:20px;">카드번호 : {{ card_num }}</p>
              <div class="divider" style="border:1px solid black;"></div>
              <p style="color:#000;  font-size:20px;">{{ card_name }}님 결제하시겠습니까?</p>
            </v-card-text>
            <v-card-actions>
              <v-spacer></v-spacer>
